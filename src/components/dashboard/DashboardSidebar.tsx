    ...
    <>
      ...
      <div className="md:hidden flex items-center justify-between px-4 py-2.5 bg-slate-900 text-white border-b border-slate-800 sticky top-0 z-40">
        <Link href="/dashboard" className="flex items-center gap-1.5 min-w-0">
          <TaaaacLogo iconSize={24} textSize="text-base" showBadge={true} badgeText="Barberly" variant="dark" />
        </Link>
      ...
      >
        ...
        <div className="p-3 border-t border-slate-800 bg-slate-900/60 space-y-2">
          ...
          <div className="flex items-center justify-between px-1 text-[10px] text-slate-400/80 font-mono">
            <span>Barberly · Taaaac</span>
            <span className="bg-slate-800/80 text-amber-400/90 border border-slate-700/60 px-1.5 py-0.5 rounded text-[9px] font-mono">
