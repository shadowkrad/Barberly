  ...
  return (
    <div className="max-w-3xl mx-auto py-12 px-4">
      <div className="bg-white rounded-2xl border border-slate-200/90 shadow-sm p-8 text-center space-y-6">
        <div className="w-16 h-16 mx-auto rounded-2xl bg-amber-50 border border-amber-100 flex items-center justify-center text-3xl shadow-xs">
          {icon}
        </div>
        ...
        <div className="p-4 rounded-xl bg-slate-50 border border-slate-200/70 text-left max-w-lg mx-auto space-y-2">
          <p className="text-xs font-bold uppercase tracking-wider text-slate-500">
            Come attivare questa funzione per Barberly:
          </p>
        ...
        <div className="pt-2 flex flex-col sm:flex-row items-center justify-center gap-3">
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className="w-full sm:w-auto inline-flex items-center justify-center gap-2 px-5 py-2.5 rounded-xl bg-amber-600 hover:bg-amber-700 text-white text-sm font-semibold shadow-sm transition cursor-pointer"
          >
