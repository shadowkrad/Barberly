/**
 * Taaaac Mailer - Dispatcher notifiche per Barberly
...
export async function sendNotificationMail(
  ...
  // 1. Invio tramite Taaaac Cloud Mail Engine (Gateway centralizzato con reputazione certificata)
  const coreUrls = [
    ...
    try {
      ...
      const res = await fetch(endpoint, {
        ...
        body: JSON.stringify({
          ...
          html: params.html,
          text: params.text,
          senderName: params.senderName || "Barberly Grooming Club",
